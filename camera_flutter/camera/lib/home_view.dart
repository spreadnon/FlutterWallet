...
class HDWallet extends StatefulWidget {
  const HDWallet({super.key});

  @override
  State<HDWallet> createState() => _HDWalletState();
}

class _HDWalletState extends State<HDWallet> {
  String _result = '';
  bool logoutVisible = false;
  //String rpcUrl = 'https://rpc.ankr.com/eth';//以太坊主网
  String rpcUrl = 'https://rpc.ankr.com/eth_goerli'; //以太坊测试网
  ...
  Future<void> initPlatformState() async {
    ...
    if (Platform.isAndroid) {
      ...
      redirectUrl = Uri.parse(
          'com.example.w3aflutter://openlogin'); //重定向回跳到app里面的需要用到的app的Bundle Identifier
    } else {
    ...
    await Web3AuthFlutter.init(Web3AuthOptions(
        // clientId:
        //     'BHHvnf7hNBR5asuIw4G5B7dD6_z7_cR9OYo9Kwq546ri2GYimZSDhUBpX13HkUKc8xpP7vGDqoSQVLh68fCGayo',
  ...
  Future<void> _chechPrivateKey() async {
    print("_chechPrivateKey");
    try {
      final prefs = await SharedPreferences.getInstance();
